.data
arreglo: .word 12, 255, 200, 150, 50, 33, 133, 100, 17, 15, 33, 188, 0, 10, 12, 40, 201, 7, 9, 10
tamano: .word 8
espacio: .asciiz " "
nueva_linea: .asciiz "\n"
...
bucle_interno:
    ...
    blt $t6, $t5, no_swap   # Si el elemento actual es menor o igual que el siguiente, no intercambiar
...
swap:
    ...
    sw $t8, 0($t4)        # Colocar el valor del segundo elemento en la posición del primero
