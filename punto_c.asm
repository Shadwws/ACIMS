...
main:
    ...
    lw $s6, largo         # Cargar el tamaño del arreglo
    subi $s6, $s6, 1      # Restar 1 al tamaño para evitar imprimir el último elemento
...
bucle_interno:
    ...
    bge $t5, $t6, no_swap # Si el elemento actual es mayor o igual que el siguiente, no intercambiar
